...
const EditModal = ({ isOpen, onCancel, onEdit, itemToEdit, units }) => {
  ...
  const handleEdit = async () => {
    try {
      await axios.put(
        `https://hotelbarvtwo.vercel.app/api/item/items/${itemToEdit._id}`,
        formData
      );
...
const NewItemModal = ({isOpen, onClose}) => {
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      await axios.delete(
        `https://hotelbarvtwo.vercel.app/api/item/items/${itemIdToDelete}`
      );
  ...
  const fetchItems = async () => {
    try {
      ...
      const itemsResponse = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/item/items"
      );
    ...
    if (name === "unit") {
      ...
      try {
        const unitDetailsResponse = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/unit/units/${value}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post("https://hotelbarvtwo.vercel.app/api/item/items", {
          ...formData,
          unit: formData.unit || "",
...
const NewGstModal = ({ isOpen, onClose }) => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://hotelbarvtwo.vercel.app/api/gst/gst/${deletingItemId}`);
  ...
  const fetchGSTList = async () => {
    try {
      const response = await axios.get('https://hotelbarvtwo.vercel.app/api/gst/list');
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('https://hotelbarvtwo.vercel.app/api/gst/create', { gstPercentage });
      fetchGSTList();
      setGSTPercentage('');
    } catch (error) {
...
const PurchaseForm = () => {
  ...
  useEffect(() => {
    const fetchStockQty = async () => {
      try {
        const response = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
        );
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        "https://hotelbarvtwo.vercel.app/api/purchase/purchase/savebill",
        data
      );
