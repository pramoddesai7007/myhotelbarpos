...
//     try {
//       const expenseResponse = await axios.get('https://hotelbarvtwo.vercel.app/api/expense/expenses');
//       setExpenses(expenseResponse.data);

//       const bankResponse = await axios.get('https://hotelbarvtwo.vercel.app/api/bankName/bankNames');
...
//     try {
//       const tableResponse = await axios.get('https://hotelbarvtwo.vercel.app/api/expensesForm');
...
//         `https://hotelbarvtwo.vercel.app/api/expensesForm/${editExpense._id}`,
//         {
//           date: expenseDate,
...
//     try {
//       const response = await axios.post('https://hotelbarvtwo.vercel.app/api/expensesForm', {
//         date: expenseDate,
//         expenseType: selectedExpense,
//         description: description,
//         paidBy: paidBy,
...
//     try {
//       await axios.delete(`https://hotelbarvtwo.vercel.app/api/expensesForm/${deleteExpense._id}`);
...
const NewExpenseModal = ({ isOpen, onClose }) => {
    ...
    const fetchExpenses = async () => {
      try {
        const response = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/expense/expenses"
        );
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(
        `https://hotelbarvtwo.vercel.app/api/expense/expenses/${selectedExpense._id}`,
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://hotelbarvtwo.vercel.app/api/expense/expenses", {
        expense: newExpense,
      });
...
const ExpenseFormList = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const bankResponse = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/bankName/bankNames"
      );
      setBankNames(bankResponse.data);
    } catch (error) {
      console.error("Error fetching data:", error);
  ...
  const fetchDataForTable = async () => {
    try {
      const tableResponse = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/expensesForm"
      );
      setTableData(tableResponse.data);
    } catch (error) {
      console.error("Error fetching table data:", error);
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(
        `https://hotelbarvtwo.vercel.app/api/expensesForm/${deleteExpense._id}`
      );
