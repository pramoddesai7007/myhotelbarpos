...
//       axios
//         .put(
//           `https://hotelbarvtwo.vercel.app/api/liquorCategory/barMenus/${editId}`,
//           newBarMenu
//         )
//         .then((response) => {
...
//       axios
//         .post("https://hotelbarvtwo.vercel.app/api/liquorCategory", newBarMenu)
//         .then((response) => {
...
//     axios
//       .delete(`https://hotelbarvtwo.vercel.app/api/liquorCategory/barMenus/${deleteId}`)
//       .then(() => {
//         setBarMenus((prevBarMenus) =>
...
const LiquorCategory = () => {
  ...
  const fetchliquor = async () => {
    try {
      const response = await axios.get('https://hotelbarvtwo.vercel.app/api/liquorCategory/barMenus');
