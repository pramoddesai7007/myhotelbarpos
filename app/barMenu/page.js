...
const NewEditModal = ({ isOpen, onClose, onMenuUpdate }) => {
  ...
  useEffect(() => {
    if (selectedLiquorBrand) {
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/liquorBrand/getMenu/${selectedLiquorBrand}`)
        .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://hotelbarvtwo.vercel.app/api/liquorBrand/barSubmenu/${selectedLiquorBrand}`,
        formData
      );
...
const BarList = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://hotelbarvtwo.vercel.app/api/liquorBrand/barSubmenu/${menuToDelete._id}`
      );
  ...
  const addNewMenu = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://hotelbarvtwo.vercel.app/api/liquorBrand/barSubmenu",
        formData
      );
  ...
  useEffect(() => {
    ...
    axios
      .get('https://hotelbarvtwo.vercel.app/api/liquorBrand/barCategory/list')
      .then((response) => {
  ...
  const handleFileUpload = async () => {
    try {
      ...
      const response = await axios.post(
        "https://hotelbarvtwo.vercel.app/api/liquorBrand/upload-excel",
        formData
      );
      ...
      const stock = await axios.post('https://hotelbarvtwo.vercel.app/api/liquorBrand/updateStock');
      console.log(stock)
