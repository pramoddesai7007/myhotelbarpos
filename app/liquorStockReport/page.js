...
//     try {
//       const res = await fetch(`https://hotelbarvtwo.vercel.app/api/liquorBrand/stockQty/barmenus?date=${selectedDate}`);
...
//     try {
//       const res = await fetch(`https://hotelbarvtwo.vercel.app/api/liquorBrand/stockQty/barmenu?date=${selectedDate}`);
//       const data = await res.json();
...
//     try {
//       const res = await fetch(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/stockQty/sellQty?date=${selectedDate}`);
//       const data = await res.json();
...
//     try {
//       const res = await fetch(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/stockQty/updateClosing`);
//       const data = await res.json();
//       console.log(data)
//       setClosingData(data);
//     } catch (error) {
...
//     try {
//       const res = await fetch(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/closeStockQty/barmenus`);
//       const data = await res.json();
//       console.log(data)
...
//   useEffect(() => {
//     if (selectedDate) {
//       fetchData(`https://hotelbarvtwo.vercel.app/api/liquorBrand/stockQty/barmenus?date=${selectedDate}`, setMenuData);
//       fetchData(`https://hotelbarvtwo.vercel.app/api/liquorBrand/stockQty/barmenu?date=${selectedDate}`, setPurchaseMenuData);
//       fetchData(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/stockQty/sellQty?date=${selectedDate}`, setSellMenuData);
//       fetchData(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/closeStockQty/barmenus?date=${selectedDate}`, setClosingStockData);
//     }
//   }, [selectedDate]);

//   useEffect(() => {
//     fetchData(`https://hotelbarvtwo.vercel.app/api/liquorBrand/order/stockQty/updateClosing`, setClosingData);
//   }, []);
