...
//             setExistingImage(
//                 menuToEdit.imageUrl
//                     ? `https://hotelbarvtwo.vercel.app/${menuToEdit.imageUrl}`
//                     : null
//             );
...
//                 `https://hotelbarvtwo.vercel.app/api/menu/menus/${menuToEdit._id}`,
//                 formData
//             );
...
//                 `https://hotelbarvtwo.vercel.app/api/menu/menus/${menuToDelete._id}`
//             );
...
//                 "https://hotelbarvtwo.vercel.app/api/menu/menu",
//                 formData
//             );
...
//             const response = await axios.post(
//                 "https://hotelbarvtwo.vercel.app/api/menu/upload-excel",
//                 formData
//             );
...
//                     {menu.imageUrl ? (
//                         <img
//                             src={`https://hotelbarvtwo.vercel.app/${menu.imageUrl}`}
//                             width={50}
//                             height={50}
//                             alt="Menu Image"
...
//                                 {menuToView?.imageUrl ? (
//                                     <img
//                                         src={`https://hotelbarvtwo.vercel.app/${menuToView.imageUrl}`}
//                                         alt="Menu"
