...
const UnitList = () => {
  ...
  const handleEditSubmit = async (e, updatedUnit) => {
    ...
    try {
      ...
      await axios.patch(`https://hotelbarvtwo.vercel.app/api/unit/units/${selectedUnit._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://hotelbarvtwo.vercel.app/api/unit/units/${selectedUnit._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://hotelbarvtwo.vercel.app/api/unit/units', { unit: newUnit });
