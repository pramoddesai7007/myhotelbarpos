...
const Billing = ({ tableId, acPercentage }) => {
    ...
    const fetchAdmins = async () => {
      try {
        const response = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/auth/admins"
        );
  ...
  const handleResetTable = async (sectionName, mainTableName) => {
    try {
      ...
      const tableResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/tables/bySection/${sectionName}/${mainTableName}`
      );
      ...
      const sectionResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/section/byName/${sectionName}`
      );
      ...
      const response = await axios.put(
        `https://hotelbarvtwo.vercel.app/api/table/${sectionId}/${mainTableId}/reset-subtables`
      );
  ...
  const handleShowSubmit = async (
    ...
    try {
      ...
      const response = await axios.put(
        `https://hotelbarvtwo.vercel.app/api/table/${sectionId}/${mainTableId}/show-subtables`,
        {
  ...
  const handleCancelKOT = async () => {
    try {
      ...
      for (const selectedItemName of selectedMenuNames) {
        ...
        await axios.patch(`https://hotelbarvtwo.vercel.app/api/kot/${tableId}`, {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/taste/tastes"
        );
  ...
  const fetchWaitersList = async () => {
    try {
      const response = await axios.get("https://hotelbarvtwo.vercel.app/api/waiter");
  ...
  useEffect(() => {
    const fetchGreetings = async () => {
      try {
        const response = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/greet/greet"
        );
  ...
  useEffect(() => {
    ...
    const fetchNextOrderNumber = async () => {
      try {
        const response = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/order/get-next-order-number"
        );
  ...
  const fetchLastAllOrders = async () => {
    try {
      const ordersResponse = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/order/latest-orders"
      );
      ...
      const tableNamesPromises = orders.map(async (order) => {
        const tableResponse = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/table/tables/${order.tableId}`
        );
  ...
  const saveBill = async () => {
    try {
      const stockResponse = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/liquorBrand/liquorBrand/stock"
      );
      ...
      const existingBillResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/order/order/${tableId}`
      );
      ...
      if (existingBill && existingBill.length > 0) {
        ...
        const updateResponse = await axios.patch(
          `https://hotelbarvtwo.vercel.app/api/order/update-order-by-id/${orderIdToUpdate}`,
          orderData
        );
      } else {
      ...
      if (
        ...
        const BOTResponse = await axios.post(
          `https://hotelbarvtwo.vercel.app/api/bot/botOrder/${tableId}`,
          kotData
        );
      ...
      const KOTResponse = await axios.post(
        `https://hotelbarvtwo.vercel.app/api/kot/kotOrder/${tableId}`,
        kotData
      );
      ...
      if (
        ...
        await axios.post(
          `https://hotelbarvtwo.vercel.app/api/liquorBrand/liquorBrand/stockOut`,
          {
            selectedParentIds,
            selectedMenusList,
          }
  ...
  const saveKot = async () => {
    try {
      ...
      const existingKOTResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/kot/kot/${tableId}`
      );
  ...
  const saveBot = async () => {
    try {
      ...
      const existingBOTResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/bot/bot/${tableId}`
      );
  ...
  const handlePrintBill = async () => {
    try {
      ...
      if (temporaryOrderIndex !== -1) {
        ...
        await axios.patch(
          `https://hotelbarvtwo.vercel.app/api/kot/kot/settle/${tableId}`
        );
      } else {
  ...
  <div class="container">
    ...
    <img class="logo" src="https://hotelbarvtwo.vercel.app/${
      hotelInfo.hotelLogo
...
<script>
  ...
  const handleCashBill = async () => {
    try {
      ...
      await axios.patch(
        `https://hotelbarvtwo.vercel.app/api/order/update/update-order-by-cash/${orderIdToUpdate}`,
        {
...
<script>
  ...
  useEffect(() => {
    ...
    // Fetch categories
    axios
      .get("https://hotelbarvtwo.vercel.app/api/main/hide")
      .then((response) => {
    ...
    axios
      .get("https://hotelbarvtwo.vercel.app/api/liquorCategory/barMenus")
      .then((response) => {
    ...
    // Fetch products
    axios
      .get("https://hotelbarvtwo.vercel.app/api/menu/menus/list")
      .then((response) => {
    ...
    // axios
    //   .get("https://hotelbarvtwo.vercel.app/api/liquorBrand/barSubmenu/list")
    //   .then((response) => {
    //     console.log(response.data);
    //     const menusArray = response.data; // Ensure menus is an array
    ...
    if (tableId) {
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/table/tables/${tableId}`)
        .then((response) => {
          setTableInfo(response.data);

          // Fetch saved bills for the table from the API
          axios
            .get(`https://hotelbarvtwo.vercel.app/api/order/savedBills/${tableId}`)
            .then((response) => {
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/menu/${selectedCategory._id}`)
        .then((response) => {
          console.log(response.data);
          const menusArray = response.data || []; // Ensure menus is an array
          setMenus(menusArray);
  ...
  useEffect(() => {
    ...
    if (selectedBarCategory) {
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/liquorBrand/${selectedBarCategory._id}`)
        .then((response) => {
          // console.log(response.data);
          const menusArray = response.data || []; // Ensure menus is an array
          setBarMenus(menusArray);
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === null) {
      ...
      // Fetch menus based on the selected category
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/menu/menulist/${category._id}`)
        .then((response) => {
          console.log(response.data);
          setMenus(response.data);
        })
  ...
  const handleBarCategoryClick = (category) => {
    ...
    if (category === null) {
      ...
      // Fetch menus based on the selected category
      axios
        .get(`https://hotelbarvtwo.vercel.app/api/liquorBrand/${category._id}`)
        .then((response) => {
          console.log(response.data);
          setBarMenus(response.data);
        })
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/hotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `https://hotelbarvtwo.vercel.app/api/hotel/get/${defaultHotelId}`
          );
    ...
    const fetchSections = async () => {
      try {
        const sectionsResponse = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/section"
        );
  ...
  const handleMergeTables = async (
    ...
    try {
      ...
      const destinationTableResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/table/bySectionAndName/${sectionId}/${destinationTableName}`
      );
      ...
      const sourceTableResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/table/bySectionAndName/${sectionId}/${sourceTableName}`
      );
      const sourceTableId = sourceTableResponse.data._id;

      // Call the mergeTables endpoint with the retrieved tableIds
      const response = await axios.patch(
        "https://hotelbarvtwo.vercel.app/api/order/mergeTables",
        {
          destinationTableId,
          sourceTableId,
        }
  ...
  const handleShiftTables = async (
    ...
    try {
      ...
      const destinationTableResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/table/bySectionAndName/${destinationSectionId}/${destinationTableName}`
      );
      const destinationTableId = destinationTableResponse.data._id;

      // Perform a lookup in the Table collection to retrieve tableId for sourceTableName in sourceSectionId
      const sourceTableResponse = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/table/table/bySectionAndName/${sourceSectionId}/${sourceTableName}`
      );
      const sourceTableId = sourceTableResponse.data._id;

      // Call the shiftTables endpoint with the retrieved tableIds
      const response = await axios.patch(
        "https://hotelbarvtwo.vercel.app/api/order/shiftBills",
        {
          destinationTableId,
          sourceTableId,
        }
                        ...
                        <div>
                          ...
                          <div className="justify-center flex">
                            <img
                              src={
                                product.imageUrl
                                  ? `https://hotelbarvtwo.vercel.app/${product.imageUrl}`
                                  : `/tray.png`
                              }
