...
//         try {
//             const response = await axios.get(`https://hotelbarvtwo.vercel.app/api/table/tables/${tableId}`);
...
//             try {
//                 const tablesResponse = await axios.get('https://hotelbarvtwo.vercel.app/api/table/tables');
...
//             try {
//                 const sectionsResponse = await axios.get('https://hotelbarvtwo.vercel.app/api/section');
...
//                 `https://hotelbarvtwo.vercel.app/api/table/${sectionId}/tables`,
//                 { numberOfTables },
//                 {
//                     headers: {
...
//         const fetchtables = async () => {
//             try {
//                 const response = await axios.get('https://hotelbarvtwo.vercel.app/api/table/tables');
...
//                 `https://hotelbarvtwo.vercel.app/api/table/tables/${tableToDelete._id}`
//             );
...
//                 `https://hotelbarvtwo.vercel.app/api/table/tables/${editTable._id}`,
//                 formData,
//                 {
//                     headers: {
//                         'Content-Type': 'application/json',
...
const Tables = () => {
    ...
    const fetchTables = async () => {
      try {
        const tablesResponse = await axios.get(
          "https://hotelbarvtwo.vercel.app/api/table/tables"
        );
        console.log(tablesResponse.data);
        setTables(tablesResponse.data);
      } catch (error) {
  ...
  //     const response = await axios.post(`https://hotelbarvtwo.vercel.app/api/table/${sectionId}/tables`, JSON.stringify(checkedinputvalue));
