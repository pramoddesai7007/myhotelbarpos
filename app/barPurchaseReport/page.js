...
const BarPurchaseReport = () => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `https://hotelbarvtwo.vercel.app/api/barPurchase/barpurchase/all?startDate=${startDate}&endDate=${endDate}`
                );
    ...
    useEffect(() => {
        const fetchVendors = async () => {
            try {
                const response = await axios.get("https://hotelbarvtwo.vercel.app/api/supplier/suppliers");
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get("https://hotelbarvtwo.vercel.app/api/barPurchase/barpurchase/all", {
                params: {
                    startDate,
                    endDate,
