...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('https://hotelbarvtwo.vercel.app/api/taste/tastes');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://hotelbarvtwo.vercel.app/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://hotelbarvtwo.vercel.app/api/taste/tastes/${selectedTaste._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://hotelbarvtwo.vercel.app/api/taste/tastes', { taste: newTaste });
