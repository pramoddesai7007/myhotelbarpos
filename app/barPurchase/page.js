...
const NewUnitModal = ({ isOpen, onClose }) => {
      ...
      const fetchUnits = async () => {
        try {
          const response = await axios.get(
            "https://hotelbarvtwo.vercel.app/api/unit/units"
          );
    ...
    const handleEditSubmit = async (e, updatedUnit) => {
      ...
      try {
        ...
        await axios.patch(
          `https://hotelbarvtwo.vercel.app/api/unit/units/${selectedUnit._id}`,
          {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        await axios.post("https://hotelbarvtwo.vercel.app/api/unit/units", {
          unit: newUnit,
        });
  
        // Fetch the updated list of units
        const response = await axios.get("https://hotelbarvtwo.vercel.app/api/unit/units");
        setUnits(response.data);
...
const VatModal = ({ isOpen, onClose }) => {
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            await axios.delete(`https://hotelbarvtwo.vercel.app/api/purchaseVAT/vat/${deletingItemId}`);
    ...
    const fetchVatList = async () => {
        try {
            const response = await axios.get('https://hotelbarvtwo.vercel.app/api/purchaseVAT/vat');
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.post('https://hotelbarvtwo.vercel.app/api/purchaseVAT/vat', { vatPercentage });
            fetchVatList();
            setVatPercentage('');
        } catch (error) {
...
const NewVendorModal = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await axios.post(
          "https://hotelbarvtwo.vercel.app/api/supplier/suppliers",
          formData
        );
    ...
    const handleEditSubmit = async (e) => {
      ...
      //     `https://hotelbarvtwo.vercel.app/api/supplier/suppliers/${editedSupplier._id}`,
      //     editedSupplier
      //   );
...
const BarPurchaseForm = () => {
    ...
    const exportToPDF = () => {
        ...
        // Add title or header
        doc.text("BarPurchase Bill Report", 14, 16);
        ...
        // Add the overall purchase details in rows
        const barpurchaseData = [
          ["Date", formData.date || ""],
          ["Due Date", formData.dueDate || ""],
          ["T.P Date", formData.tpDate || ""],
          ...
          // ["Bottle size", formData.barCategory || ""],
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get(
                    "https://hotelbarvtwo.vercel.app/api/liquorBrand/barSubmenu/all"
                );
    ...
    useEffect(() => {
        const fetchChildMenuNames = async () => {
            try {
                const response = await axios.get(
                    `https://hotelbarvtwo.vercel.app/api/liquorBrand/childmenus/list`
                );
    ...
    useEffect(() => {
        const fetchStockQty = async () => {
            try {
                const response = await axios.get(
                    `https://hotelbarvtwo.vercel.app/api/barPurchase/purchase/childMenuStockQty?name=${formData.name}`
                );
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axios.post(
                "https://hotelbarvtwo.vercel.app/api/barPurchase/bar/purchase/savebill",
                data
            );
            ...
            if (parseFloat(data.total) > 0) {
                ...
                await axios.post("https://hotelbarvtwo.vercel.app/api/supplier/supplier/debit", {
                    vendorName,
                    amount: parseFloat(data.paidAmount),
                });
            } else {
                // If there is no paid amount, update the supplier's credit balance
                await axios.post("https://hotelbarvtwo.vercel.app/api/supplier/supplier/credit", {
                    vendorName,
