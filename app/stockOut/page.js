...
const NewItemModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      try {
        const itemsResponse = await axios.get("https://hotelbarvtwo.vercel.app/api/item/items");
  ...
  useEffect(() => {
    ...
    const fetchUnits = async () => {
      try {
        const unitsResponse = await axios.get("https://hotelbarvtwo.vercel.app/api/unit/units");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      response = await axios.post("https://hotelbarvtwo.vercel.app/api/item/items", {
        ...formData,
        unit: formData.unit || "",
...
const StockOutwardForm = () => {
  ...
  const handleAddItems = async () => {
    try {
      ...
      await axios.post("https://hotelbarvtwo.vercel.app/api/stockOut/stockOut/addItems", {
        waiterName,
        productName,
        stockQty,
        availableQuantity,
      ...
      await axios.post("https://hotelbarvtwo.vercel.app/api/item/items/updateQuantity", {
        productName,
        stockQty,
      });
    ...
    try {
      if (name === "waiterName") {
        ...
        const response = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/waiter/waiter/mobile?name=${value}`
        );
        setMobileNumber(response.data.mobileNumber);
      } else if (name === "productName") {
        setProductName(value);
        const response = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/item/items/quantity?productName=${value}`
        );
  ...
  const fetchProductNames = async () => {
    try {
      const response = await axios.get("https://hotelbarvtwo.vercel.app/api/item/items");
  ...
  const fetchStockOutwardList = async () => {
    try {
      const response = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/stockOut/stockOut"
      );
