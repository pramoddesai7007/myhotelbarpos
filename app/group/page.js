...
const GroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `https://hotelbarvtwo.vercel.app/api/menu/${selectedMainCategory}/assignmenus`,
        {
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/main/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://hotelbarvtwo.vercel.app/api/menu/${selectedMainCategory}/removemenus`,
        {
