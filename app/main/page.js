...
//         `https://hotelbarvtwo.vercel.app/api/main/${mainCategory._id}`
//       );
...
//         `https://hotelbarvtwo.vercel.app/api/main/${menu._id}`
//       );
...
//         `https://hotelbarvtwo.vercel.app/api/main/${editedMenu._id}`,
//         formData,
//         {
//           headers: {
//             "Content-Type": "multipart/form-data",
...
//       const updatedMenusResponse = await axios.get("https://hotelbarvtwo.vercel.app/api/main");
...
//     const completeImageUrl = `https://hotelbarvtwo.vercel.app/${mainImage}`;
...
//                     <img
//                       src={`https://hotelbarvtwo.vercel.app/${mainCategoryToView.mainImage}`}
//                       alt="Main Category"
