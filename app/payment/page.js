...
const PaymentModal = ({
  ...
  const fetchMobileNumbers = async () => {
    try {
      const response = await axios.get(
        "https://hotelbarvtwo.vercel.app/api/customer/mobile-numbers"
      );
    ...
    try {
      ...
      if (formData.mobileNumber) {
        const customerResponse = await axios.get(
          `https://hotelbarvtwo.vercel.app/api/customer/get-customer-by-mobile/${formData.mobileNumber}`
        );
        ...
        if (parseFloat(formData.dueAmount) > 0) {
          ...
          if (updatedCreditBalance > 0) {
            await axios.patch(
              `https://hotelbarvtwo.vercel.app/api/customer/update-credit-balance/${existingCustomer._id}`,
              {
      ...
      const response = await axios.patch(
        `https://hotelbarvtwo.vercel.app/api/order/update-order-by-id/${orderID}`,
        {
          ...formData,
  ...
  const addNewCustomer = async () => {
    ...
    const newCustomerResponse = await axios.post(
      "https://hotelbarvtwo.vercel.app/api/customer/customer/list/add-customer",
      {
        customerName: formData.customerName,
        mobileNumber: formData.mobileNumber,
      }
  ...
  const fetchCustomerDetails = async (mobileNumber) => {
    try {
      const response = await axios.get(
        `https://hotelbarvtwo.vercel.app/api/customer/get-customer-by-mobile/${mobileNumber}`
      );
  ...
  const handlePaymentMethodClick = async () => {
    try {
      ...
      await axios.put(
        `https://hotelbarvtwo.vercel.app/api/order/order/update-flag/${orderNumber}`
      );
